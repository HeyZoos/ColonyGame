...
fn startup(mut commands: Commands, assets: Res<AssetServer>) {
    ...
    for layer_idx in (0..tiled_map.layers().len()).rev() {
        ...
        commands.entity(tilemap_entity).insert(TilemapBundle {
            ...
            tile_size,
            transform: dbg!(get_tilemap_center_transform(&tilemap_size, &grid_size, &map_type, layer_idx as f32)),
            ..Default::default()
        });
    }
}
...
fn resource_layer_startup_system(
    ...
    commands.entity(resource_tilemap_entity).insert(TilemapBundle {
        ...
        transform: dbg!(get_tilemap_center_transform(&resource_tilemap_size, &resource_grid_size, &resource_map_type, 5.0)),
        ..Default::default()
    });
}